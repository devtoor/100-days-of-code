...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        self.down = self.driver.find_element(
            by=By.XPATH,
            value='//*[@id="container"]/div/div[3]/div/div/div/div[2]/'
    ...
    def tweet_at_provider(self):
        ...
        ).send_keys(os.getenv("twitter_password"), Keys.ENTER)
        ...
        self.driver.find_element(
            by=By.XPATH,
            value='//*[@id="react-root"]/div/div/div[2]/main/div/div/div/div/div/div'
